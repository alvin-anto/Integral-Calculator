...
//    {
//        return searchRecurive(getRoot(), node);
//    }
    
//    Node<T>* remove(Node<T>* node)
//    {
//        return removeRecursive(node, getRoot());
//    }

//    Node<T>* insertRecursive(Node<T>* curr, Node<T>* newNode)
//    {
//        std::cout << "Curr: " << curr->getData() << std::endl;
...
//    Node<T>* parentOfLeftMax(Node<T>* baseNode)
//    {
//        Node<T>* curr = baseNode->getLeft();
//        Node<T>* parent = baseNode;
//        while (curr->getRight())
//        {
//            parent = curr;
//            curr = curr->getRight();
...
//void print2DUtil(Node<T>* base, int space)
//    {
//        // Base case
//        if (base == NULL)
//            return;
...
//        print2DUtil(base->getRight(), space);
//
...
//            std::cout << " ";
//        std::cout << base->getData() << "\n";
//
//        // Process left child
//        print2DUtil(base->getLeft(), space);
//    }
//
//    // Wrapper over print2DUtil()
//    void print2D(Node<T>* base)
//    {
//        print2DUtil(base, 0);
//    }
